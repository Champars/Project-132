...
function setup() {
    ...
    document.getElementById("game_status").innerHTML = "Status: Detecting Objects";
}
...
function draw() {
    ...
    if (status != "") {
        ...
        for (index = 0; index < o.length; index++) {
            document.getElementById("game_status").innerHTML = "Objects Detected";
            fill("red");
